...
my_id = '5483d0bc39332d679bebaab12539c408'

def home(request):
    if request.method =='POST':
        #입력된 내용으로
        #https://api.themoviedb.org/3/search/movie?api_key=5483d0bc39332d679bebaab12539c408&language=en-US&page=1&include_adult=false
